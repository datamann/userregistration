...
async function mayBeAllowed_1(init?: EndpointRequestInit_1): Promise<boolean> { return client_1.call("UserController", "mayBeAllowed", {}, init); }
...
export { createUser_1 as createUser, deleteById_1 as deleteById, findAll_1 as findAll, findByEmail_1 as findByEmail, findByID_1 as findByID, findByLastname_1 as findByLastname, mayBeAllowed_1 as mayBeAllowed, update_1 as update };
